...
const Footer = ({ id }: FooterProps) => {
  ...
  return (
   <div id={id} className="relative min-h-[440px] overflow-hidden rounded-4xl">
    {/* Video Background */}
    <video 
      ref={videoRef}
      autoPlay 
   ...
   {/* Desktop */}
    <div className="box-border max-w-full hidden md:block relative z-30">
      <Card className="grid justify-between p-8 md:grid-cols-3 gap-6 items-stretch bg-card/5 text-white md:min-h-[440px]">
        {/* Left Side */}
    ...
    {/* Mobile */}
    <div className="box-border max-w-full block md:hidden relative z-30">
      <Card className="grid justify-between p-6 gap-4 bg-card/5 min-h-[440px] text-white">
        <div className="col-span-1">
          <h1 className="text-2xl font-extrabold text-left">Got an opportunity available? Send it my way!</h1>
        </div>
        <div>
          <p className="text-xl font-bold px-4">Here&apos;s how to get in touch with me:</p>
         </div>
