  ...
  export const resumeData: resumeData[] = [
    {
      ...
      skills: ["AWS", "Azure", "TypeScript", "Github", "Atlassian Confluence", "Security Vulnerability Remediation", "Pipeline Engineering", "Infrastructure Deployment", "Technical Documentation", "Knowledge Transfer", "Cloud Infrastructure Management"],
    ...
    },
    {
      ...
      skills: ["Agile Methodology", "Business Software Debugging", "System Optimization", "Technical Platforms", "Cross-Functional Coordination", "Stakeholder Management", "Analytical Problem-Solving", "Operational Efficiency", "Project Workflows", "Communication Systems Management"],
    ...
    },
    {
      ...
      skills: ["Dashboard Development", "AI/ML Model Research", "Machine Learning Architecture", "Engineering Team Leadership", "Data Visualization", "Stakeholder Communication", "Research Collaboration", "Metrics Analysis"],
    ...
    },
    {
      ...
      skills: ["DSA", "HTML5", "CSS3", "Javascript", "React", "Node.JS", "Python", "Flask", "Express", "OOP", "APIs", "SQL"],
    ...
    },
    {
      ...
      skills: ["ArcGIS", "Analyst Notebook", "Signals Intelligence", "Top Secret Clearance", "CI Polygraph", "IC Tools", "Data Analysis", "Data Interpreation", "Database Management", "Metadata", "System Administration", "Technical Reporting", "Leadership", "Project Management"],
